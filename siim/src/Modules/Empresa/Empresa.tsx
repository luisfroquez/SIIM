    ...
    <VStack  pt={{ base: 8, md: 16, xl: 32 }} spacing={0} id="empresa">
      ...
      >
        ...
        <Text w="100%">
          ...
          Prestamos servicio en las áreas de seguridad electrónica, electricidad
          ...
          <br />
          <br />
          Por ello, nuestra empresa de protección contra incendios tiene claros
          sus objetivos, entre los que se encuentra realizar el trabajo de forma
          correcta sin mirar el tiempo necesario para llevarlo a cabo. La
          principal finalidad es que los equipos que instalemos, y/o revisemos,
          estén en perfecto estado de funcionamiento cuando se necesiten.
        </Text>
      </Stack>
      <Carousel />
    </VStack>
